...
**محتاج تعديل قبل الإطلاق:** غيّر عناوين البريد `privacy@mobpos.app` و
`dpo@mobpos.app` في `public/privacy.html` لعناوينك الحقيقية.
...
لو لقيت ثغرة أمنية، ابعت على **security@mobpos.app** ومتنشرهاش علناً قبل الإصلاح.
