...
- **اختيار سيريل IMEI** عند بيع جهاز — يتم ربطه تلقائياً بالعميل والفاتورة
...
- **توليد باركود تلقائي** (بم_prefix_ مصر 622) مع checksum
- **طباعة ملصقات باركود** جاهزة للصق على المنتجات (Code 128)
- **منتجات بالسيريل (IMEI)** ومنتجات بدون — النظام يتعامل مع الاثنين
...
- **تصدير Excel (CSV)** مع دعم كامل للعربية (BOM)
...
│   │   ├── Sales.tsx           # سجل المبيعات والمرتبعات
...
| مش بيدعم IMEI والسيريلات | تتبع كل جهاز برقمه التسلسلي |
